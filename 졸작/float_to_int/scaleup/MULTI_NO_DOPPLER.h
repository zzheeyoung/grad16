	...
	// "gaussian_v2_0.h" 대신 다른 Gaussian random generator를 사용하여도 된다.
{
	...
	float model_b[2] = { 1.825434946682913,0.237105926885955 }; // 실내
	float model_c[3] = { 2.394772531850241,1.530741835103085, 0.242383686176621 }; // 대지
	float model_d[7] = { 2.394772531850241,1.530741835103085, 1.214049611412611, 0.485150132444030, 0.153108746168203, 0.108392691402120, 0.069183097091894 }; // 졸작 전시장? 강당?
